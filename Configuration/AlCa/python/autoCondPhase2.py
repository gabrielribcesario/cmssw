...
allTags["TkAlignment"] = {
    ...
    'T40' : ( ','.join( [ 'TrackerAlignment_Upgrade2026_T40_design_v1' ,TkAlRecord, 'sqlite_fip:tkLa-dev/DesignAlignment/data/TrackerAlignment_Upgrade2026_T40_design_v1.db', "", ""] ), ),
}
...
allTags["TkAPE"] = {
    ...
    'T40' : ( ','.join( [ 'TrackerAlignmentErrorsExtended_Upgrade2026_T40_design_v1' ,TkAPERecord, 'sqlite_fip:tkLa-dev/DesignAlignment/data/TrackerAlignment_Upgrade2026_T40_design_v1.db', "", ""] ), ),
}
...
activeDets = ["T35","T36","T37","T38","T40"]
phase2GTs = {}
