...
allTags["SimLA"] = {
    ...
    'T37' : ( ','.join( [ 'SiPixelSimLorentzAngle_phase2_IT_v7.4.1_25x10０_v2_mc' ,SiPixelSimLARecord,connectionString, "", "2０２４-０４-０８ １６:００:００.０００"] ), ), #uH = ₀.₀５３/T (TBPX  L２,L３,L４), uH=₀.₀/T (TBPX L１ TEPX+TFPX)
