...
allTags["TkAlignment"] = {
    ...
    'T37' : ( ','.join( [ 'TrackerAlignment_Upgrade2026_T37_design_v1' ,TkAlRecord,
                         'sqlite_file:/home/garibeir/CMSSW_14_1_1/src/tkLa-dev/DesignAlignment/data/TrackerAlignment_Upgrade2026_T37_design_v1.db', "", ""] ), ),
    'T38' : ( ','.join( [ 'TrackerAlignment_Upgrade2026_T38_design_v1' ,TkAlRecord, connectionString, "", "2024-09-12 15:37:00"] ), ),
    'T40' : ( ','.join( [ 'TrackerAlignment_Upgrade2026_T40_design_v1' ,TkAlRecord,
                             'sqlite_file:/home/garibeir/CMSSW_14_1_1/src/tkLa-dev/DesignAlignment/data/TrackerAlignment_Upgrade2026_T40_design_v1.db', "", ""] ), ),
}
...
allTags["TkAPE"] = {
    ...
    'T37' : ( ','.join( [ 'TrackerAlignmentErrorsExtended_Upgrade2026_T37_design_v1' ,TkAPERecord,
                         'sqlite_file:/home/garibeir/CMSSW_14_1_1/src/tkLa-dev/DesignAlignment/data/TrackerAlignment_Upgrade2026_T37_design_v1.db', "", ""] ), ),
    'T38' : ( ','.join( [ 'TrackerAlignmentErrorsExtended_Upgrade2026_T36_design_v1' ,TkAPERecord, connectionString, "", "2024-09-12 15:37:00"] ), ),
    'T40' : ( ','.join( [ 'TrackerAlignmentErrorsExtended_Upgrade2026_T40_design_v1' ,TkAPERecord,
                         'sqlite_file:/home/garibeir/CMSSW_14_1_1/src/tkLa-dev/DesignAlignment/data/TrackerAlignment_Upgrade2026_T40_design_v1.db', "", ""] ), ),
}
...
activeDets = ["T21","T25","T30","T33","T36","T37","T38", "T40"]
phase2GTs = {}
